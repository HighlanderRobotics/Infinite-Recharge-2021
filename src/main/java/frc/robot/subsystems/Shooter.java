...
public class Shooter extends SubsystemBase {
  ...
  private NetworkTableEntry flywheelReadoutIdle =
    ...
    .getEntry();
  private NetworkTableEntry sus =
    tab.add("have a gift u sussy baka uwu", "69")
    .withPosition(4,3)
    .getEntry();
  String kevinFace = String.join("\n"
  ,",&&&&&&&&&&%#***/#%&&@@@@@@@&    .,,#####%&&%%%%%%%%%%         .,#&@@@@@@@@@@@@@&"
  ,",%%&&&&&&&%%#((#%%((%@@@@@@&  .,*(*,/#%%%%%%%&&%%%%&%..    ...*&&&@@@@@@@@@&((%&"
  ,",#%%%&&&&&&&&&&&&@@@@@@#/%@% .*#(,/#%%%&&%%&&&&&&&&%%,....... /%&&&&&&#/(&@@@@@@"
  ,".//((#%&&&&&&&@@@@@@@@@@@@@%,###(%%%%&&&&%%&&&&&&&%&&&%#(.  . ,#%//%%%%%%&&&@@@@"
  ...
  private NetworkTableEntry kevin =
    tab.add("kevin is daddy", kevinFace)
...
(targetRPM) / ((100ms per 1 second = 10) (sec per min = 60)) 
  ...
  */
  ...
  public void periodic() {
    flywheelReadoutIdle.setBoolean(convertVelocitytoRPM(firstMotor.getSelectedSensorVelocity()) < 3900);
  }
}