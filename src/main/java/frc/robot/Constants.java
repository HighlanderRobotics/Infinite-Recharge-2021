...
public final class Constants {
    ...
    // Climber Encoders
    // Distances in inches
    public static int[] kWinchEncoderPorts = {6,7}; // 6,7
    public static int[] kWheelEncoderPorts = {0,1}; // 2,3
    public static int[] kWinchMotorEncoderPorts = {2,3}; //0,1 (seemed like these were switched)
    ...
    // spindexer positions
    public static double spindexerStart = 0.086; //0.5;
    ...
    public static final double hoodMin = 28.0;
    public static final double hoodMax = 73.0;
     //fix kF and peakOut
}
